...
object Keys {
    ...
    const val IS_EXECUTE_INSERT = "com.cleannote.notelist.isexecuteinsert"
    const val REQ_SCROLL_TOP_KEY = "com.cleannote.notelist.scrolltop"

    const val GLIDE_DETAIL_VIEW_STATE_KEY = R.id.detail_vp_item
}